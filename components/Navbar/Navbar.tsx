  ...
  return (
   <nav className="sticky top-0">
    ...
    <div className='md:hidden'>
      <button id='menu-toggle' className='text-white' onClick={toggleMenu} title="Toggle menu">
        <svg 
        fill='none'
        stroke='currentColor'
        strokeLinecap='round'
    ...
    <a className="duration-50 hover:scale-125 " href='https://www.linkedin.com/in/loom-pl-173a8a314/' target="_blank" rel="noopener">
    <Image
      src={linkedin}
      alt="Picture of the author"
      width={15}
    /></a>
    <a className="duration-50 hover:scale-125" href='https://www.instagram.com/yod_non/' target="_blank"  rel="noopener">
    <Image
      src={instragram}
      alt="Picture of the author"
      width={20}
